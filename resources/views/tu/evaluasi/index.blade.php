<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('tu.evaluasi.create') }}" class="inline-flex items-center px-4 py-2 bg-indigo-600 text-white rounded-md hover:bg-indigo-700 text-sm font-medium btn-pulse">
                + Beri Evaluasi
            </a>
        </div>
    </x-slot>
            ...
            <div class="bg-white shadow-sm sm:rounded-lg animate-fade-in-up anim-delay-1">
                ...
                @else
                    <div class="p-8 text-center">
                        ...
                        <a href="{{ route('tu.evaluasi.create') }}" class="inline-flex items-center px-4 py-2 bg-indigo-600 text-white rounded-md hover:bg-indigo-700 text-sm">
