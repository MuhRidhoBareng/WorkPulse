<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Dashboard Kepala SKB</h2>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <a href="{{ route('kepala.rekap.index') }}" class="bg-white shadow-sm sm:rounded-lg p-6 hover:shadow-md transition group">
                    <div class="flex items-center">
                        <div class="flex-shrink-0 bg-indigo-100 rounded-lg p-3 group-hover:bg-indigo-200 transition">
                        ...
                        <div class="ml-4">
                            <h3 class="text-lg font-semibold text-gray-800">Rekap Kinerja</h3>
                            <p class="text-sm text-gray-500">Lihat rekapitulasi kehadiran & kegiatan per Pamong</p>
                        </div>
                    </div>
                </a>

                <a href="{{ route('kepala.evaluasi.create') }}" class="bg-white shadow-sm sm:rounded-lg p-6 hover:shadow-md transition group">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <h3 class="text-lg font-semibold text-gray-800">Beri Evaluasi</h3>
