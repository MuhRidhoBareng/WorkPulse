...
class PerformanceReviewController extends Controller
{
    public function index()
    {
        ...
        return view('kepala.evaluasi.index', compact('reviews'));
    }
    ...
    public function create()
    {
        ...
        return view('kepala.evaluasi.create', compact('pamongs'));
    }
    ...
    public function store(Request $request)
    {
        ...
        // Cek duplikasi evaluasi untuk Pamong dan periode yang sama
